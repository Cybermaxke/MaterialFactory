...
public abstract class EnchantmentCustomChestplate extends EnchantmentCustomArmor {

	public EnchantmentCustomChestplate(int id) {
		super(id);
	}
	...
	public boolean canEnchantItem(ItemStack itemstack) {
		...
		return item.getClass().isAssignableFrom(Classes.NMS_ITEM_ARMOR) && ((Integer) ReflectionUtils.getFieldObject(Classes.NMS_ITEM_ARMOR, "a", item)) == 1;
	}
